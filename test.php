...
<p class="pager">
    ...
    if($page <= 1){
    ?>
    <a href="test.php?page=1">이전</a>
    <?php } else{ ?>
    <a href="test.php?page=<?php echo ($page-1); ?>">이전</a>
    <?php };?>
    ...
    ?>
    <a href="test.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
    <?php };?>
    ...
    if($page >= $total_page){
    ?>
    <a href="test.php?page=<?php echo $total_page; ?>">다음</a>
    <?php } else{ ?>
    <a href="test.php?page=<?php echo ($page+1); ?>">다음</a>
    <?php };?>
