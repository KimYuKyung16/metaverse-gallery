...
<head>
  ...
  <link rel="stylesheet" href="western_gallery_list1.css">
  <title>서양화 진행중인 전시회</title>
</head>
...
<body>
  ...
  <main>
    ...
    <?php
    $conn = mysqli_connect('localhost', 'root', 'apmsetup', 'gallery_db');
    $sql = "SELECT * FROM users WHERE gallery_subject='western' AND visable = 1 ORDER BY num DESC;";
    $result = mysqli_query($conn, $sql);
    ?>
