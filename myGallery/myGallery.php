			...
			<ul class="slidelist">
				...
				<li>
					<div id="gallery_start">
						<p class="logo">Gallery</p>
						<div id="image-div">
							<p id="start_btn">갤러리시작</p>
							<video src="../image/gallery_video.mp4" muted autoplay loop></video>
						</div>
						<div id="main-div">
							<div id="fold-div">
							...
							<div id="gallery_info-div">
								...
								<div id="gallery_review">
									...
									<table id="gallery_review_table">
										...
										<tbody>
											...
											?>
												<tr>
													<td><?= $row['nickname'] ?></td>
													<td colspan="2"><?= $row['review'] ?><div id="revise_delete-btn" style="display: none;">
															<p>수정</p>
															<p>삭제</p>
														</div>
													</td>
									...
									<div id="page" class="pager">
										...
										if ($page <= 1) {
										?>
											<a href="myGallery.php?num=<?= $gallery_num ?>&page=1"><input type="button" value="<"></a>
										<?php } else { ?>
											<a href="myGallery.php?num=<?= $gallery_num ?>&page=<?php echo ($page - 1); ?>"><input type="button" value="<"></a>
										<?php }; ?>
										...
										?>
											<a href="myGallery.php?num=<?= $gallery_num ?>&page=<?php echo $print_page; ?>"><input type="button" value=<?= $print_page; ?>></a>
										<?php
										}; ?>
										...
										if ($page >= $total_page) {
										?>
											<a href="myGallery.php?num=<?= $gallery_num ?>&page=<?php echo $total_page; ?>"><input type="button" value=">"></a>
										<?php } else { ?>
											<a href="myGallery.php?num=<?= $gallery_num ?>&page=<?php echo ($page + 1); ?>"><input type="button" value=">"></a>
										<?php }; ?>
									</div>
				...
				<li>
					<div class="scroll" id="scroll1">
						...
						<div class="frame_image-div">
							<div>
								<img class="frame" src="../image/frame1.png" alt="frame" width="400" height="500">
						...
						<div class="floor"><img class="floor_img" src="../image/floor2.jpg" alt="floor"></div>
...
<script type="module" src="./pictureInfo.js"></script>
<script type="text/javascript">
	let gallery_num = "<?php echo $gallery_num; ?>";

	function showPopup(picture_num) {
		window.open("./pictureInfo.php?picture_num=" + picture_num + "&gallery_num=" + gallery_num, "read", "width=600, height=900, left=450, top=50");
	}
</script>
